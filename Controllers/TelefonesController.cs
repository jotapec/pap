...
namespace SalaoIedaV4.Controllers
{
    public class TelefonesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idTelefone,num_tel_principal,num_tel_secundario,data_atualizacao_principal,data_atualizacao_secundario")] Telefone telefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idTelefone,num_tel_principal,num_tel_secundario,data_atualizacao_principal,data_atualizacao_secundario")] Telefone telefone)
        {
            if (ModelState.IsValid)
            {
